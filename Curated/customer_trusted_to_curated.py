...
CustomerCurated_node1702108285363 = glueContext.getSink(
    path="s3://de-aws-nv-stedi-lake-house/customer/curated/",
    connection_type="s3",
    updateBehavior="UPDATE_IN_DATABASE",
    partitionKeys=[],
    enableUpdateCatalog=True,
    transformation_ctx="CustomerCurated_node1702108285363",
)
CustomerCurated_node1702108285363.setCatalogInfo(
    catalogDatabase="stedi", catalogTableName="customer_curated"
)
CustomerCurated_node1702108285363.setFormat("json")
CustomerCurated_node1702108285363.writeFrame(Joinprivacycustomer_node1702108175107)
job.commit()
